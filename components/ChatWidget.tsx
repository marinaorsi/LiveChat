        ...
        <div className="relative z-10 px-6 pb-4 pt-0">
          <div className="bg-[#2a2a2a] rounded-[24px] p-1 flex border border-white/5">
            <button 
              ...
              className={`flex-1 flex flex-col items-center justify-center py-3 rounded-[20px] transition-colors group cursor-pointer ${activeView === ViewState.HOME ? 'bg-white/5' : ''}`}
            >
            ...
            <button 
              ...
              className="flex-1 flex flex-col items-center justify-center py-3 rounded-[20px] transition-colors group cursor-pointer"
            >
